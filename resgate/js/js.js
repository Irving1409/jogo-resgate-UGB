...
var perdidos = 0;
var energiaAtual = 3;
var somFundo = document.getElementById("som")
var somDisparo = document.getElementById("somDisparo");
var somExplosao = document.getElementById("somExplosao");
var somGameover = document.getElementById("somGameover");
var somPerdido = document.getElementById("somPerdido");
var somResgate = document.getElementById("somResgate");
var TECLA = {W:87, S:83, D:68, A:65, E:69}
...
function reposicionaInimigo2(){
  ...
  function energia(){
    if(energiaAtual == 3){
      $("#energia").css("background-image","url(imgs/healt_bar_full.png");
    }
    if(energiaAtual == 2){
      $("#energia").css("background-image","url(imgs/healt_bar_middle.png");
    }
    if(energiaAtual == 1){
      $("#energia").css("background-image","url(imgs/healt_bar_low.png");
    }
    if(energiaAtual == 0){
      $("#energia").css("background-image","url(imgs/healt_bar_empty.png");
      //Game Over
      gameOver();
    }
